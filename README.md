...
approval, conflicts, aliases) see `docs/INTERPRETER_ARCHITECTURE.md`. For the recipes module (data
model, product linking, shopping list integration, visibility model) see `docs/RECIPES_ARCHITECTURE.md`.
For design tokens, typography and UI components see `DESIGN_SYSTEM.md`.
